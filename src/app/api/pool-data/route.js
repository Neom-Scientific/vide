        ...
        if (testName === "Myeloid") {
            ...
            for (let i = 0; i < rows.length; i++) {
                ...
                if (sampleExists) {
                    ...
                    await pool.query(
                        `UPDATE master_sheet SET qubit_dna = $2, data_required = $3, conc_rxn = $4, barcode = $5, i5_index_reverse = $6, i7_index = $7, lib_qubit = $8, nm_conc = $9, lib_vol_for_2nm = $10, nfw_volu_for_2nm = $11, total_vol_for_2nm = $12, pool_no = $13, size = $14, test_name = $15, hospital_name = $16 WHERE sample_id = $1`,
                        [sample_id, qubit_dna, data_required, conc_rxn, barcode, i5_index_reverse, i7_index, lib_qubit, nm_conc, lib_vol_for_2nm, nfw_volu_for_2nm, total_vol_for_2nm, pool_no, size, testName, hospital_name]
                    );
                    response.push({
            ...
            for (let i = 0; i < rows.length; i++) {
                ...
                console.log('sample_id out', sample_id);
                if (!sample_id) {
                    ...
                    await pool.query(`UPDATE master_sheet SET qubit_dna = $2, data_required = $3, per_rxn_gdna = $4, volume = $5, gdna_volume_3x = $6, nfw = $7, plate_designation = $8, well = $9, i5_index_reverse = $10, i7_index = $11, qubit_lib_qc_ng_ul = $12, stock_ng_ul = $13, lib_vol_for_hyb = $14, gb_per_sample = $15, pool_no = $16, test_name = $17, hospital_name = $18, pool_conc = $19, size = $20, nm_conc = $21, one_tenth_of_nm_conc = $22, total_vol_for_2nm = $23, lib_vol_for_2nm = $24, nfw_volu_for_2nm = $25 WHERE sample_id = $1`,
                        [sample_id, qubit_dna, data_required, per_rxn_gdna, volume, gdna_volume_3x, nfw, plate_designation, well, i5_index_reverse, i7_index, qubit_lib_qc_ng_ul, stock_ng_ul, lib_vol_for_hyb, gb_per_sample, pool_no, testName, hospital_name, pool_conc, size, nm_conc, one_tenth_of_nm_conc, total_vol_for_2nm, lib_vol_for_2nm, nfw_volu_for_2nm]);
                    response.push({
                        message: 'Data updated successfully',
                        status: 200
                ...
                if (sampleExists) {
                   await pool.query(
                    ...
                    console.log('sample_id in', sample_id);
                    await pool.query(
                        `UPDATE master_sheet SET qubit_dna = $2, data_required = $3, per_rxn_gdna = $4, volume = $5, gdna_volume_3x = $6, nfw = $7, plate_designation = $8, well = $9, i5_index_reverse = $10, i7_index = $11, qubit_lib_qc_ng_ul = $12, stock_ng_ul = $13, lib_vol_for_hyb = $14, gb_per_sample = $15, pool_no = $16, test_name = $17, hospital_name = $18, pool_conc = $19, size = $20, nm_conc = $21, one_tenth_of_nm_conc = $22, total_vol_for_2nm = $23, lib_vol_for_2nm = $24, nfw_volu_for_2nm = $25  WHERE sample_id = $1`,
                        [sample_id, qubit_dna, data_required, per_rxn_gdna, volume, gdna_volume_3x, nfw, plate_designation, well, i5_index_reverse, i7_index, qubit_lib_qc_ng_ul, stock_ng_ul, lib_vol_for_hyb, gb_per_sample, pool_no, testName, hospital_name,pool_conc, size, nm_conc, one_tenth_of_nm_conc, total_vol_for_2nm, lib_vol_for_2nm, nfw_volu_for_2nm]
                    );
            ...
            for (let i = 0; i < rows.length; i++) {
                ...
                if (sampleExists) {
                   ...
                   await pool.query(
                        `UPDATE master_sheet SET qubit_dna = $2, data_required = $3, well = $4, i7_index = $5, sample_volume = $6, qubit_lib_qc_ng_ul = $7, pooling_volume = $8, pool_conc = $9, size = $10, nm_conc = $11, one_tenth_of_nm_conc = $12, total_vol_for_2nm = $13, lib_vol_for_2nm = $14, nfw_volu_for_2nm = $15, pool_no = $16, test_name = $17, hospital_name = $18 WHERE sample_id = $1`,
                        [sample_id, qubit_dna, data_required, well, i7_index, sample_volume, qubit_lib_qc_ng_ul, pooling_volume, pool_conc, size, nm_conc, one_tenth_of_nm_conc, total_vol_for_2nm, lib_vol_for_2nm, nfw_volu_for_2nm, pool_no, testName, hospital_name]
                    );
                    response.push({
                        message: 'data updated successfully',
